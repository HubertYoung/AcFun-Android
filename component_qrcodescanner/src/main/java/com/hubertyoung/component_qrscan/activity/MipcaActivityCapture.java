...
import com.hubertyoung.component_qrscan.camera.CameraManager;
import com.hubertyoung.component_qrscan.decoding.CaptureActivityHandler;
import com.hubertyoung.component_qrscan.decoding.InactivityTimer;
import com.hubertyoung.component_qrscan.qrdecode.BarcodeFormat;
import com.hubertyoung.component_qrscan.qrdecode.DecodeEntry;
import com.hubertyoung.component_qrscan.view.ViewfinderView;
...
public class MipcaActivityCapture extends AppCompatActivity {
	...
	public void onCreate( Bundle savedInstanceState ) {
		...
		languageBtn.setText( getResources().getString( R.string.language_text ) + "C++(Zxing,Zbar)" );
		hasSurface = false;
...
//		playBeepSoundAndVibrate();
		Toast.makeText( MipcaActivityCapture.this, "" + result, Toast.LENGTH_SHORT ).show();
	...
	private void initCamera( SurfaceHolder surfaceHolder ) {
		try {
			...
			CommonLog.loge( e );
			ToastUtil.showError( R.string.qrcodescanner_open_camera_error );
			return;
		}
		if ( handler == null ) {
