...
extern "C" jstring Java_com_hubertyoung_component_qrscan_qrdecode_DecodeEntry_DecodeEntry_decodeFromJNI(JNIEnv *env, jobject thiz,
                                                                                   jint decodeCode,
                                                                                   jbyteArray data,
                                                                                   jint dataWidth,
                                                                                   jint dataHeight,
...
extern "C" jstring Java_com_hubertyoung_component_qrscan_qrdecode_DecodeEntry_decodeFileFromJNI(JNIEnv *env, jobject thiz,
                                                                                       jint decodeCode,
                                                                                       jintArray pixels,
