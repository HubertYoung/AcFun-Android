package com.hubertyoung.pay.platforms.qq;
...
//                    new PlatformDb(  )
					...
					userInfo.getUserInfo( new IUiListener() {
						...
						public void onError( UiError uiError ) {
							...
							if ( callback != null ) {
								callback.onFailed( mActivity, ResultCode.RESULT_FAILED, toMessage( uiError ) );
							}
						}
						...
						public void onCancel() {
							if ( callback != null ) {
								callback.onFailed( mActivity, ResultCode.RESULT_CANCELLED, "" );
							}
						}
					} );
