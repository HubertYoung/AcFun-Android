...
public class EmbedPluginViewActivity extends AppCompatActivity {
	...
	private void initViews() {
		final Context pluginContext = PhantomCore.getInstance().createPluginContext( this, "com.wlqq.phantom.plugin.view" );
		...
		if ( iService != null ) {
			...
			try {
				...
				if ( fragment != null ) {
					getSupportFragmentManager().beginTransaction().add( R.id.frl_embed_fragment, fragment ).commit();
				}
