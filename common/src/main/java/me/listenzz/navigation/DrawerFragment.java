...
public class DrawerFragment extends AwesomeFragment implements DrawerLayout.DrawerListener {
    ...
    public View onCreateView( @NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        int screenWidth = AppScreenUtils.getScreenWidth(requireContext());
        int margin1 = AppScreenUtils.dp2px(requireContext(), minDrawerMargin);
        ...
        int margin2 = screenWidth - AppScreenUtils.dp2px(requireContext(), maxDrawerWidth);
        int margin = Math.max(margin1, margin2);
        layoutParams.rightMargin = margin - AppScreenUtils.dp2px(requireContext(), 64);
