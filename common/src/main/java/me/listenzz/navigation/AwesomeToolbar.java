...
public class AwesomeToolbar extends Toolbar {
    ...
    public void addLeftButton(Drawable icon, String title, int tintColor, boolean enabled, OnClickListener onClickListener) {
        if (leftButton != null) {
            removeView(leftButton);
        }
        if (leftButtons == null) {
    ...
    public void addRightButton(Drawable icon, String title, int tintColor, boolean enabled, OnClickListener onClickListener) {
        if (rightButton != null) {
            removeView(rightButton);
        }
        if (rightButtons == null) {
    ...
    public void setLeftButton(Drawable icon, String title, int tintColor, boolean enabled, OnClickListener onClickListener) {
    ...
    public void setRightButton(Drawable icon, String title, int tintColor, boolean enabled, OnClickListener onClickListener) {
    ...
    @SuppressLint( "NewApi" )
	private void setButton( TextView button, Drawable icon, String title, int tintColor, boolean enabled, OnClickListener onClickListener) {
        ...
        int disableColor = ColorUtils.blendARGB( AppScreenUtils.toGrey(color), backgroundColor, 0.75f);
