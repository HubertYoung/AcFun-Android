...
public class Style implements Cloneable {
    ...
    protected Style(Context context) {
        ...
        statusBarColor = AppScreenUtils.fetchContextColor(context, R.attr.colorPrimaryDark);
        toolbarBackgroundColor = AppScreenUtils.fetchContextColor(context, R.attr.colorPrimary);
        toolbarHeight = AppScreenUtils.fetchContextDimension(context, R.attr.actionBarSize);
    }
    ...
    public void setElevation(int dp) {
        this.elevation = AppScreenUtils.dp2px(context, dp);
    }
    ...
    public int getElevation() {
        ...
        elevation = AppScreenUtils.dp2px(context, 4);
        return elevation;
    }
