...
//                return true;
//            case TelephonyManager.NETWORK_TYPE_UNKNOWN://(不知道网络类型)
//                return false;
//            default:
//                return false;
//        }
...
//        return (((ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE)).getNetworkInfo(ConnectivityManager.TYPE_MOBILE))
//                .isConnected();
//    }
//
//
