...
public class NetworkUtil {
     ...
     * 判断是否有网络可用
     *
     * @return true isConnected,false unConnected
     */
    public static boolean isNetAvailable() {
        try {
            ConnectivityManager connectivity = ( ConnectivityManager ) CommonApplication.getAppContext().getSystemService( Context.CONNECTIVITY_SERVICE );
