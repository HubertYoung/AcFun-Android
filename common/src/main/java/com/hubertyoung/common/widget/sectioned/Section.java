...
public abstract class Section {
	...
	public Section( @LayoutRes int itemResourceId, @LayoutRes int loadingResourceId, @LayoutRes int failedResourceId ) {
		this( new SectionParameters.Builder( itemResourceId ).loadingResourceId( loadingResourceId )
	...
	public Section( @LayoutRes int headerResourceId, @LayoutRes int itemResourceId, @LayoutRes int loadingResourceId, @LayoutRes int failedResourceId ) {
		this( new SectionParameters.Builder( itemResourceId ).headerResourceId( headerResourceId )
	 ...
	 */
	public abstract RecyclerView.ViewHolder getItemViewHolder( View view, int itemType );
