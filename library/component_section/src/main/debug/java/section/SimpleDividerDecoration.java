...
public class SimpleDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public SimpleDividerDecoration( Context context, @Orientation int orientation ) {
...
//        VIEW_TYPE_FAILED
//        VIEW_TYPE_EMPTY
        if ( viewType == SectionedRecyclerViewAdapter.VIEW_TYPE_LOADING ||
                viewType == SectionedRecyclerViewAdapter.VIEW_TYPE_FAILED ||
                viewType == SectionedRecyclerViewAdapter.VIEW_TYPE_EMPTY ||
                viewType == SectionedRecyclerViewAdapter.VIEW_TYPE_HEADER ||
                viewType == SectionedRecyclerViewAdapter.VIEW_TYPE_FOOTER ) {
            return;
        } else {
