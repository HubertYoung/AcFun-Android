...
import dialog.custom.CustomAttachPopup;
import dialog.custom.CustomAttachPopup2;
import dialog.custom.CustomDrawerPopupView;
import dialog.custom.CustomEditTextBottomPopup;
import dialog.custom.CustomFullScreenPopup;
import dialog.custom.PagerBottomPopup;
import dialog.custom.PagerDrawerPopup;
import dialog.custom.QQMsgPopup;
import dialog.custom.ZhihuCommentPopup;
...
//                        .popupAnimation(PopupAnimation.NoAnimation)
                        .setPopupCallback(new SimpleCallback() {
                            ...
                            public boolean onBackPressed() {
                                ToastUtil.showWarning("我拦截的返回按键，按返回键XPopup不会关闭了");
                                return true;
                            }
