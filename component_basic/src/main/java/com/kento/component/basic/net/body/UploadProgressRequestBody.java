package com.kento.component.basic.net.body;

import android.support.annotation.NonNull;
import android.util.Log;

import com.kento.component.basic.net.callback.UCallback;
import com.kento.component.basic.net.config.MediaTypes;
...
public class UploadProgressRequestBody extends RequestBody {
	...
	public UploadProgressRequestBody( File file, UCallback callback ) {
		this.requestBody = RequestBody.create( MediaTypes.IMAGE_TYPE, file );
		this.callback = callback;
	}
			...
			Observable.just( currentLength )
					  ...
					  .subscribe( new Consumer< Long >() {
						  ...
						  public void accept( Long aLong ) throws Exception {
							  Log.i( "tag", "upload progress currentLength:" + aLong + ",totalLength:" + totalLength );
							  callback.onProgress( aLong, totalLength, ( ( float ) aLong ) / totalLength * 100 );
						  }
