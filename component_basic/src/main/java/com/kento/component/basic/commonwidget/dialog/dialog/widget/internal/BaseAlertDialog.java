package com.kento.component.basic.commonwidget.dialog.dialog.widget.internal;
...
public abstract class BaseAlertDialog< T extends BaseAlertDialog< T > > extends BaseDialog< T > {
	...
	public void setUiBeforShow() {
		...
		mTvTitle.setText( mTitle == null ? "温馨提示" : mTitle );
	...
	public void setBtnRightTextType( Typeface defaultBold ) {
		if ( mTvBtnRight != null ) {
			mTvBtnRight.setTypeface( defaultBold );
		}
	}
}
