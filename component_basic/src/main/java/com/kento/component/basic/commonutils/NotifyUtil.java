...
///**
// * NotifyUtil
// * Created by suqi on 2017/4/6 11:26
// * 通知栏
// */
//
//@SuppressLint("NewApi")
...
//     * @param content
//     */
//    public void notify_button(int smallIcon, int leftbtnicon, String lefttext, PendingIntent leftPendIntent, int rightbtnicon, String righttext,
//                              PendingIntent rightPendIntent, String ticker,
//                              String title, String content, boolean sound, boolean vibrate, boolean lights) {
//
...
//                              String ticker, String title, String content, int leftbtnicon, String lefttext, PendingIntent leftPendingIntent, int
//                                      rightbtnicon, String righttext, PendingIntent rightPendingIntent, boolean sound, boolean vibrate, boolean
//                                      lights) {
//
//        setCompatBuilder(pendingIntent, smallIcon, ticker, title, content, sound, vibrate, lights);
