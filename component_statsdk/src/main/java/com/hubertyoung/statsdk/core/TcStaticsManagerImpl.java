 ...
 */
package com.hubertyoung.statsdk.core;

import android.content.Context;
import android.text.TextUtils;

import com.alibaba.fastjson.JSON;
import com.hubertyoung.statsdk.constants.StaticsConfig;
import com.hubertyoung.statsdk.db.helper.DataConstruct;
import com.hubertyoung.statsdk.db.helper.StaticsAgent;
import com.hubertyoung.statsdk.model.DataBlock;
import com.hubertyoung.statsdk.service.Platform;
import com.hubertyoung.statsdk.util.JsonUtil;
import com.hubertyoung.statsdk.util.NetworkUtil;
import com.hubertyoung.statsdk.util.StatLog;
    ...
    public void onSend() {
        ...
        Platform.get().execute( new Runnable() {
            ...
            public void run() {
                ...
                StatLog.d(TcNetEngine.TAG, "TcStatfacr >> report is Start");
