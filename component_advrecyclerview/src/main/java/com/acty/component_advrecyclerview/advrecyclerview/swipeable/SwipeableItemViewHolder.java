...
package com.acty.component_advrecyclerview.advrecyclerview.swipeable;

import android.support.annotation.Nullable;
import android.view.View;

import com.acty.component_advrecyclerview.advrecyclerview.swipeable.annotation.SwipeableItemAfterReactions;
...
public interface SwipeableItemViewHolder {
     ...
     *              - {@link com.acty.component_advrecyclerview.advrecyclerview.swipeable.SwipeableItemConstants#STATE_FLAG_SWIPING}
     *              - {@link com.acty.component_advrecyclerview.advrecyclerview.swipeable.SwipeableItemConstants#STATE_FLAG_IS_ACTIVE}
     *              - {@link com.acty.component_advrecyclerview.advrecyclerview.swipeable.SwipeableItemConstants#STATE_FLAG_IS_UPDATED}
     */
     ...
     *               - {@link com.acty.component_advrecyclerview.advrecyclerview.swipeable.RecyclerViewSwipeManager#RESULT_NONE}
     *               - {@link com.acty.component_advrecyclerview.advrecyclerview.swipeable.RecyclerViewSwipeManager#RESULT_SWIPED_LEFT}
     *               - {@link com.acty.component_advrecyclerview.advrecyclerview.swipeable.RecyclerViewSwipeManager#RESULT_SWIPED_UP}
     *               - {@link com.acty.component_advrecyclerview.advrecyclerview.swipeable.RecyclerViewSwipeManager#RESULT_SWIPED_RIGHT}
     *               - {@link com.acty.component_advrecyclerview.advrecyclerview.swipeable.RecyclerViewSwipeManager#RESULT_SWIPED_DOWN}
     *               - {@link com.acty.component_advrecyclerview.advrecyclerview.swipeable.RecyclerViewSwipeManager#RESULT_CANCELED}
     */
     ...
     *                 - {@link com.acty.component_advrecyclerview.advrecyclerview.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_DEFAULT}
     *                 - {@link com.acty.component_advrecyclerview.advrecyclerview.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_MOVE_TO_ORIGIN}
     *                 - {@link com.acty.component_advrecyclerview.advrecyclerview.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_REMOVE_ITEM}
     *                 - {@link com.acty.component_advrecyclerview.advrecyclerview.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_MOVE_TO_SWIPED_DIRECTION}
     *                 - {@link com.acty.component_advrecyclerview.advrecyclerview.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_DO_NOTHING}
     */
     ...
     *               - {@link com.acty.component_advrecyclerview.advrecyclerview.swipeable.RecyclerViewSwipeManager#OUTSIDE_OF_THE_WINDOW_LEFT}
     *               - {@link com.acty.component_advrecyclerview.advrecyclerview.swipeable.RecyclerViewSwipeManager#OUTSIDE_OF_THE_WINDOW_RIGHT}
     */
     ...
     * @param amount Item swipe amount. Generally the range is [-1.0 .. 1.0] if the proportional amount mode is enabled, otherwise distance in pixels.
     *               In additionally, these special values can also be accepted;
     *               - {@link com.acty.component_advrecyclerview.advrecyclerview.swipeable.RecyclerViewSwipeManager#OUTSIDE_OF_THE_WINDOW_TOP}
     *               - {@link com.acty.component_advrecyclerview.advrecyclerview.swipeable.RecyclerViewSwipeManager#OUTSIDE_OF_THE_WINDOW_BOTTOM}
     */
