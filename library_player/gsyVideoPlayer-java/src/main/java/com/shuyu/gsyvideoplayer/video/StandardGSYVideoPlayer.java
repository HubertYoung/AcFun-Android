...
public class StandardGSYVideoPlayer extends GSYVideoPlayer {
	...
	protected void showProgressDialog( float deltaX, String seekTime, int seekTimePosition, String totalTime, int totalTimeDuration ) {
		if ( mProgressDialog == null ) {
			...
			if ( localView.findViewById( getProgressDialogProgressTextId() ) instanceof TextView ) {
				mDialogSeekTimeText = ( ( TextView ) localView.findViewById( getProgressDialogProgressTextId() ) );
			}
	 ...
	 * 有自定义的实现逻辑可重载showProgressDialog方法
	 */
	protected int getProgressDialogProgressTextId() {
		return R.id.sub_info_text;
	}
