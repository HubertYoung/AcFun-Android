...
public class GridPasswordView extends LinearLayout implements PasswordView {
	...
	private static final int DEFAULT_LINECOLOR = 0xffF6F6F7;
	private static final int DEFAULT_GRIDCOLOR = 0xffF6F6F7;
...
//	}
	...
	private void initAttrs( Context context, AttributeSet attrs, int defStyleAttr ) {
		...
		if ( mTextColor == null ) mTextColor = ColorStateList.valueOf( getResources().getColor( android.R.color.primary_text_light ) );
		...
		if ( TextUtils.isEmpty( mPasswordTransformation ) ) mPasswordTransformation = DEFAULT_TRANSFORMATION;
	...
	private void initViews( Context context ) {
		...
		super.setPadding(Util.dp2px( context,1 ), Util.dp2px( context,1 ), Util.dp2px( context,1 ), Util.dp2px( context,1 ));
