package com.hubertyoung.common.utils.bar;
...
//			window.setStatusBarColor( getColorPrimary(window));
	 ...
	 * @param animated
	 */
	public static void setStatusBarColor( @NonNull final AppCompatActivity activity, @ColorInt int color, boolean animated ) {
	 ...
	 * @param activity
	 */
	public static void statusBarLightMode( AppCompatActivity activity, boolean dark ) {
		Window window = activity.getWindow();
	...
	public static void setStatusBarHidden( AppCompatActivity activity, boolean hidden ) {
		Window window = activity.getWindow();
