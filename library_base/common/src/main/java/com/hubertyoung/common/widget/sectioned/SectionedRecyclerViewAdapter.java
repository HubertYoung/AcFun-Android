...
import static com.hubertyoung.common.widget.sectioned.Section.State;
...
public class SectionedRecyclerViewAdapter extends RecyclerView.Adapter< RecyclerView.ViewHolder > implements ItemDragHelperCallback.OnItemMoveListener {
    ...
    public void setPageBean( PageBean mPageBean ) {
    ...
    private Map< String, Integer > sectionViewTypeNumbers;
