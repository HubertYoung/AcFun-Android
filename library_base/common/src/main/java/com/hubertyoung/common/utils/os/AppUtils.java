...
public class AppUtils {
     ...
     */
    public static synchronized void installApp( final AppCompatActivity activity, final String filePath, final String authority, final int requestCode ) {
     ...
     * @param requestCode 请求值
     */
    public static synchronized void installApp( final AppCompatActivity activity, final File file, final String authority, final int requestCode ) {
        if ( !FileUtils.isFileExists( file ) ) return;
    ...
    public static boolean isServiceRunning( String className ) {
        ...
        ActivityManager activityManager = ( ActivityManager ) CommonApplication.getAppContext().getSystemService( Context.ACTIVITY_SERVICE );
