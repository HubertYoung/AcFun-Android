 ...
 */
public class NewRecommendVideosSection extends StatelessSection {
	...
	public NewRecommendVideosSection( BaseActivity activity, boolean isVideoNew ) {
		super( SectionParameters.builder().itemResourceId( R.layout.item_home_video ).headerResourceId( R.layout.widget_region_header_text ).build() );
		...
		viewHolder.itemView.setOnClickListener( new View.OnClickListener() {
			...
			public void onClick( View v ) {
				if ( mOnItemClickListener != null ) {
					mOnItemClickListener.onClickRecommendBangumiItem( v, regionBodyContent );
				}
			}
		} );
	}
	...
	public interface OnItemClickListener {
		void onClickRecommendBangumiItem( View v, RegionBodyContent bodyContentsBean );
	}
