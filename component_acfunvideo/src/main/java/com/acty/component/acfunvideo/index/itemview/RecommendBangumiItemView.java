package com.acty.component.acfunvideo.index.itemview;
 ...
 * @date:2018/9/4 16:53
 * @since:V$VERSION
 * @desc:com.acty.component.acfunvideo.index.itemview
 */
public class RecommendBangumiItemView {
	...
	public RecommendBangumiItemView( Context context ) {
		...
		spaceWidth = ( DisplayUtil.getScreenWidth( context ) - ( ( DisplayUtil.px2dip( 15.0f ) * 2 ) + ( DisplayUtil.px2dip( 9.0f ) * 2 ) ) ) / 3;
	}
