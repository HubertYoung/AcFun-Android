package com.kento.component_skeleton.skeleton;
...
public class ViewReplacer {
    ...
    public void restore() {
        if (mSourceParentView != null) {
            ...
            mCurrentView = mSourceView;
//            mTargetView.destroyDrawingCache();
//			mTargetView.clearAnimation();
//			if ( mTargetView instanceof ShimmerLayout ){
//				ShimmerLayout targetView = ( ShimmerLayout ) mTargetView;
