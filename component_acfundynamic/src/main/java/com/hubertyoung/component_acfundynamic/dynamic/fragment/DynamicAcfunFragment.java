 ...
 */
public class DynamicAcfunFragment extends AbsLifecycleFragment< DynamicAcfunViewModel > {
...
//		http://apipc.app.acfun.cn/v3/regions/recommendUp?pageNo=1&pageSize=20
    ...
    protected void dataObserver() {
        registerObserver( DynamicConstants.EVENT_KEY_DYNAMIC_RECOMMENDUP, RecommendBangumiEntity.class ).observe( this, new Observer< RecommendBangumiEntity >() {
            @Override
            public void onChanged( RecommendBangumiEntity recommendBangumiEntity ) {
                if ( recommendBangumiEntity != null ) {
                    setRecommendUpInfo( recommendBangumiEntity.list );
                }
            }
        } );
    }
