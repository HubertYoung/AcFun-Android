 ...
 * @since:
 * @see com.hubertyoung.component_gamecenter.gamecenter.section.GameCenterCarouselsSection
 */
public class GameCenterCarouselsSection extends StatelessSection {
	private BaseActivity mActivity;
	private Regions regions;

	public GameCenterCarouselsSection( BaseActivity activity ) {
